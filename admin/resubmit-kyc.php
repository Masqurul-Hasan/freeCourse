...
$page_title = 'Resubmit KYC';
$meta_description = 'Resubmit required KYC list';
...
$stmt = $pdo->query("
    ...
    WHERE u.kyc_status = 'resubmit_required'
    ...
    <div class="container">
        <div class="card" style="padding: 24px;">
            <div class="section-head">
                <h1>Resubmit KYC তালিকা</h1>
                <p>যেসব ইউজারকে KYC পুনরায় জমা দিতে বলা হয়েছে, সেগুলো এখানে দেখানো হচ্ছে</p>
            </div>
                        ...
                        <tbody>
                            <?php foreach ($kycRows as $index => $row): ?>
                                <tr>
                                    ...
                                    <td><?= e($row['updated_at'] ?: $row['submitted_at'] ?: '—'); ?></td>
