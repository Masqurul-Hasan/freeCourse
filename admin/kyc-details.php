...
<img 
src="<?= SITE_URL . '/' . e($kyc['nid_front_image']); ?>" 
alt="NID Front" 
class="kyc-preview-image">
...
<a 
href="<?= SITE_URL . '/' . e($kyc['nid_front_image']); ?>" 
target="_blank" 
class="btn-light">Full View</a>
...
এই ইউজার ফ্রন্ট NID submit করেনি।
...
<img 
src="<?= SITE_URL . '/' . e($kyc['nid_back_image']); ?>" 
alt="NID Back" 
class="kyc-preview-image">
...
<a 
href="<?= SITE_URL . '/' . e($kyc['nid_back_image']); ?>" 
target="_blank" 
class="btn-light">Full View</a>
...
এই ইউজার ব্যাক NID submit করেনি।
...
<h3>KYC Attempt History</h3>

<?php if (!empty($kyc_attempts)): ?>
...
<?php foreach ($kyc_attempts as $attempt): ?>
...
<td>
<?= e($attempt['nid_number']); ?>
</td>

<td>
<?= e($attempt['bkash_number']); ?>
</td>

<td>
<?= e($attempt['submitted_at'] ?? 'N/A'); ?>
</td>

<td>

<?php if (!empty($attempt['nid_front_image'])): ?>
<a href="<?= SITE_URL . '/' . e($attempt['nid_front_image']); ?>" target="_blank">Front</a>
<?php endif; ?>

|

<?php if (!empty($attempt['nid_back_image'])): ?>
<a href="<?= SITE_URL . '/' . e($attempt['nid_back_image']); ?>" target="_blank">Back</a>
<?php endif; ?>
...
<form 
action="<?= SITE_URL; ?>/actions/admin/approve-kyc-action.php" 
method="POST" 
class="inline-form">
...
<form 
action="<?= SITE_URL; ?>/actions/admin/reject-kyc-action.php" 
method="POST" 
...
name="admin_comment" 
id="reject_comment" 
placeholder="কেন reject করা হচ্ছে তা লিখুন"
required></textarea>
...
<form 
action="<?= SITE_URL; ?>/actions/admin/resubmit-kyc-action.php" 
method="POST" 
class="review-form-block">
...
name="admin_comment" 
id="resubmit_comment" 
placeholder="যেমন: ছবিটি ঝাপসা, অনুগ্রহ করে পরিষ্কার ছবি দিন"
required></textarea>
